...
\begin{document}
    ...
    \begin{center}
        \fbox{$\rho_0 = 3,2 \cdot 10^{-1} ~ \text{Ом} \cdot \text{м}$}
    \end{center}

    \noindent Найдем отсюда удельную проводимость.

    \begin{center}
        \fbox{$\sigma = 3,1 ~ (\text{Ом} \cdot \text{см})^{-1}$}
    \end{center}
    ...
    \begin{center}
        ...
        $U_0 = -38$ мкВ \\
    \end{center}
    \input{tables/HallEffect[table]Current1.tex}
    \begin{figure}[h!]
        \centering
    ...
    \begin{center}
        ...
        $U_0 = -17$ мкВ \\
    \end{center}
    \input{tables/HallEffect[table]Current2.tex}
    \begin{figure}[h!]
        \centering
    ...
    \begin{center}
        \fbox{$R_h = 0,0418 ~ \frac{\text{Ом}}{\text{А}}$} \\
        \fbox{$n = 1,5 \cdot 10^{20} ~ \text{м}^{-3} = 1,5 \cdot 10^{16} ~ \text{см}^{-3}$}
    \end{center}
