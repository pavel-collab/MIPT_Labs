\newcommand{\HRule}{\rule{\linewidth}{0.7mm}} % Defines a new command for the horizontal lines, change thickness here
	...
	\begin{center}
		...
		\Large Лабораторная работа по курсу общей физики № 5.10.1\\[0.5cm] % Preambule of your document title
		
		
		\HRule
		\\[0.4cm]
		{ \huge \bfseries Электронный парамагнитный резонанс}% Title of your document
		\\[0.4cm] 
		\HRule
		\\[0.5cm]
...
\setcounter{page}{2}
\fancyfoot[c]{\thepage}
\fancyhead[L] {Работа № Б01-009} % some information in page header
\fancyhead[R]{}
